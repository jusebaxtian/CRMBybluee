...
export function TagFollowupsToggle({
  ...
  return (
    <button
      ...
      title={
        excludesFollowups
          ? "Los contactos con esta etiqueta están excluidos de automatizaciones (por palabra clave o etiqueta) y de seguimientos — clic para quitar"
          : "Marcar: excluir a los contactos con esta etiqueta de automatizaciones y seguimientos (ej: clientes que ya compraron)"
      }
